...
UserSchema.methods.createHash = function (plainTextPassword) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield bcrypt_1.default.hash(plainTextPassword, 10);
    });
};
...
exports.Account = mongoose_1.default.models.Account || mongoose_1.default.model("Account", AccountSchema);
